...
const mockTimeSlots: TimeSlot[] = getDefaultTimeSlots().map((slot, index) => ({
  ...slot,
  id: String(index + 1),
...
const mockClasses: ClassWithTimeSlot[] = DAYS_OF_WEEK.flatMap(day =>
...
const mockWeeklySchedule = ScheduleService.buildWeeklySchedule(mockClasses);
...
const selectedClassIds = DAYS_OF_WEEK.filter(
