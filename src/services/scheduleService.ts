import type { ClassWithTimeSlot, WeeklySchedule, ScheduleSelectionWithClass } from '../types'
...
export class ScheduleService {
  ...
  static getGradeName(grade: number): string {
    switch (grade) {
      case 1: return 'כיתה א׳'
      case 2: return 'כיתה ב׳'
      case 3: return 'כיתה ג׳'
      case 4: return 'כיתה ד׳'
      case 5: return 'כיתה ה׳'
      case 6: return 'כיתה ו׳'
      default: return `כיתה ${grade}`
    }
  }
