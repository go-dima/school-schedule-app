export class NotificationService {
   ...
   */
  static async notifyAdminsOfPendingApproval(userEmail: string, requestedRole: string): Promise<void> {
    try {
      ...
      console.log(`🔔 בקשה חדשה לאישור - ${userEmail} מבקש תפקיד: ${roleDisplay}`)
